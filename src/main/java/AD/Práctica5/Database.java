...
public class Database {
    ...
    static String c_ruta_padre = "src/main/java/AD/Práctica5";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            lanzaConsulta(v_con_db, "call world.fill_dim_lan('ABW');", v_log_writter);
            lanzaConsulta(v_con_db, "call world.fill_dim_lan('ABW');", v_log_writter);
    ...
    private static Connection conecta_db(BufferedWriter v_log_buf) {
        ...
        try {
            v_conexion = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306", "root", "usuario");
